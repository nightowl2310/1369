      ...
      <ul className="example-2">
        <li className="icon-content">
          <a href="https://linkedin.com/" aria-label="LinkedIn" data-social="linkedin">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width={32} height={32} fill="currentColor" className="bi bi-linkedin" viewBox="0 0 16 16" xmlSpace="preserve">
        ...
        <li className="icon-content">
          <a href="https://www.github.com/" aria-label="GitHub" data-social="github">
            <div className="filled" />
            <svg xmlns="http://www.w3.org/2000/svg" width={32} height={32} fill="currentColor" className="bi bi-github" viewBox="0 0 16 16" xmlSpace="preserve">
        ...
        <li className="icon-content">
          <a href="https://www.instagram.com/" aria-label="Instagram" data-social="instagram">
            <div className="filled" />
            <svg xmlns="http://www.w3.org/2000/svg" width={32} height={32} fill="currentColor" className="bi bi-instagram" viewBox="0 0 16 16" xmlSpace="preserve">
        ...
        <li className="icon-content">
          <a href="https://youtube.com/" aria-label="Youtube" data-social="youtube">
            <div className="filled" />
            <svg xmlns="http://www.w3.org/2000/svg" width={32} height={32} fill="currentColor" className="bi bi-youtube" viewBox="0 0 16 16" xmlSpace="preserve">
